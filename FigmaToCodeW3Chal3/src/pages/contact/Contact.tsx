    ...
    <>
      <div className="container">
        <section className="about-section contact">
          <div className="about-texts">
            <h5>CONTACT US</h5>
            <h1>
              Get in touch <br className="desktop" /> today!
            </h1>
            ...
            <div className="contacts flex-column gap-20">
              <p>
                Phone : +451 215 <NumberAnimation finalNumber={215} />
              </p>
              <p>
                Fax : +451 215 <NumberAnimation finalNumber={215} />
              </p>
            </div>
            <div className="freeT-media d-flex gap-20">
              <a href="#">
                <LazyLoadImage effect="blur" src={twitter} alt="Twitter logo" />
              </a>
              <a href="#">
                <LazyLoadImage
                  effect="blur"
      ...
      <div className="container desk-container">
        <section className="location flex-column">
          ...
          <h2>
            We help small businesses <br className="desktop" /> with big ideas
          </h2>
          <div className="contact-cards">
            ...
            />
            <ContactCard
              imageSrc={contactImg2}
              imageAlt="Location image"
              middle={true}
            />
            <ContactCard
              imageSrc={contactImg3}
              imageAlt="Mail image"
              middle={false}
            />
          </div>
