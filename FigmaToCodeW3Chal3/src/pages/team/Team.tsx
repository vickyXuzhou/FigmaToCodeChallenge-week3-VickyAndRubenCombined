    ...
    <>
      <section className="what-we-do">
        <div className="container">
          ...
          <p className="breadcum d-flex">
            <a href="#" className="text-bold">
              Home
            </a>{" "}
            <LazyLoadImage effect="blur" src={rightArrow} alt=">" />{" "}
      ...
      <section className="free-trial">
        <div className="container">
          ...
          <h6 className="text-gray">
            ...
            <br className="desktop" /> do met sent. RELIT official consequent.
          </h6>
          ...
          <div className="freeT-media d-flex">
            ...
            <a href="#">
              <LazyLoadImage effect="blur" src={facebook} alt="Facebook logo" />
            </a>
            <a href="#">
              <LazyLoadImage
                effect="blur"
            ...
            <a href="#">
              <LazyLoadImage effect="blur" src={linkedin} alt="Linkedin logo" />
            </a>
          </div>
        </div>
      </section>
