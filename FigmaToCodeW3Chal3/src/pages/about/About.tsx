        ...
        <section className="stats">
          <div className="stat">
            <p className="stat-number">
              <NumberAnimation finalNumber={15}></NumberAnimation>K
            </p>
            <p className="stat-desctipion">happy customers</p>
          </div>
          <div className="stat">
            <p className="stat-number">
              <NumberAnimation finalNumber={150}></NumberAnimation>K
            </p>
            <p className="stat-desctipion">Monthly visitors</p>
          </div>
          <div className="stat">
            <p className="stat-number">
              <NumberAnimation finalNumber={15}></NumberAnimation>
            </p>
            <p className="stat-desctipion">countries WorldWide</p>
          </div>
          <div className="stat">
            <p className="stat-number">
              <NumberAnimation finalNumber={100}></NumberAnimation>+
            </p>
        ...
        <section className="team">
          <div className="team-intro flex-column gap-20">
            ...
            <p className="text-gray">
              ...
              <br className="desktop" /> the two major realms of Classical
      ...
      <section className="work-with-us">
        <div className="blue-side flex-column">
          ...
          <p className="text-white">
            ...
            small-scale behavior during the first carter of the 20th{" "}
          </p>
